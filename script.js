(function (doc) {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Read data from different CSV files, run transformations and cleansing, join datasets to easy query and some data exploration Details and more informations, you can access on <a href="https://github.com/ebraimcarvalho/my-way/tree/main/scalac" target="_blank">Github Repo</a>',
