    ...
    <div class="container-fluid mt-4">
      <div class="row mx-0">
        <div class="col-lg-7 mb-3">
          <a href="/post">
            <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/Rectangle 233.svg" alt="">
            <div style="background: #C4C4C4; max-width: 746px;" class="py-4 px-4 p-lg-5 mx-0">
              <p style="color: black"><strong>Lorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem </strong></p>
              <div class="d-flex justify-content-between mt-2 mt-lg-4">
                <span style="color: black"><small>Leitura: 5 min</small></span>
                <a class="d-none d-lg-flex" href="/blog">
                  <button class="btn shadow-none py-3 px-5 button-blue fs-14" >Ler mais</button>
                </a>
              </div>
            </div>
          </a>
        ...
        <div class="col-lg-5 pl-lg-1">
          <div style="background: #C4C4C4;" class="pt-4 px-4 px-lg-5 mb-4">
            <p style="color: black"><strong>Lorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem </strong></p>
            <div class="d-flex justify-content-between mt-2 pb-2 mt-lg-4">
              <span style="color: black"><small>Leitura: 5 min</small></span>
              <a class="mb-4 d-none d-lg-flex" href="/blog">
  ...
  <section class="container">
    <div class="row">
      <div class="col-lg-4 mt-5">
        <a class="d-flex justify-content-center" href="/blog">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/Rectangle 190.svg" alt="" class="img-fluid">
          <div style="background: #C4C4C4; max-width: 413px;" class="pt-4 px-4 mb-4 mx-auto mt-n2 mt-lg-n4">
            <p style="color: black"><strong>Lorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem IpsiumLorem </strong></p>
            <div class="d-flex justify-content-between mt-2 pb-2 mt-lg-4">
              <span style="color: black"><small>Leitura: 5 min</small></span>
              <a class="mb-4 d-none d-lg-flex" href="/blog">
