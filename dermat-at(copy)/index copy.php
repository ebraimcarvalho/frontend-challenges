<?php get_header(); ?>
  ...
  <main>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <div class="d-flex mt-5">
            <img src="<?php the_field('autor_foto') ?>" alt="Imagem Corpo Clínico" >
            <div class="d-flex flex-column justify-content-center pl-lg-5 pl-4">
              <h3><?php the_field('autor_post') ?></h3>
              <p class="fs-14"><?php the_field('especialidade') ?></p>
              <p class="fs-14"><?php the_field('crm') ?></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container px-0 mt-5">
      <img src="<?php the_field('post_background') ?>" alt="" class="img-fluid">
    </div>

    <article class="container text-post small mt-5 mb-5">
      <p><?php the_content() ?></p>
    </article>
    <?php endwhile; ?>
    <?php else: endif; ?>
        ...
        <div class="row mx-0 align-items-center justify-content-center text-center mt-3">
          ...
          <div class="col-11 col-lg-6">
            <div class="input-group">
              <input type="email" class="form-control shadow-none home__input" placeholder="e-mail" aria-label="Recipient's username" aria-describedby="button-addon2">
  ...
  <article class="container px-0 mt-3 mt-5">
  ...
  <section class="call__actions container mt-5 px-0">
    ...
    <div class="row mx-0 text-center">
      <div class="col-lg-6 px-0 px-lg-3">
        ...
        <h4 class="my-4">Pele, Unha e Cabelo</h4>
        <a href="/pele">
          <button class="mb-5 btn shadow-none py-2 px-5 button-blue fs-14" >Saiba Mais</button>
        </a>
      </div>
