...
<?php get_header(); ?>
  ...
  <main>
    <div class="container-fluid m-0 p-0">
      <div class="row m-0">
        <div style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/images/Rectangle 202.svg'); background-size: cover; height: 461px;" class="col-lg-6 p-0">
        ...
        <div style="background-color: #43AFDA; position: relative;" class="col-lg-6 p-0 pb-4">
          <div class="text-white ml-3 pt-5 pl-4 pl-lg-5 pr-lg-5">
            <h1 class="text-white mt-4">Dermatologia Oncológica</h1>
            <p class="mt-4 pr-4">Possuimos os melhores profissionais para cirurgia dermatológica geral e oncologia cutânea. Nossos especialistas estão aptos para lhe oferecer o melhor diagnóstico e tratamento clínico-cirúrgico para a saúde da sua pele.</p>
            <div class="mt-5 mb-3">
  ...
  <section class="container text-center mb-4">
    <h2 class="my-4">#Todos Contra o Câncer de Pele</h2>
    <p class="fs-14 mb-5">A nossa clínica é o ambiente adequado  para o seus exames periódicos e também para identificação das lesões suspeitas de câncer da pele, usando o diagnóstico por imagens, exames não invasivos, como o mapeamento corporal total e a dermatoscopia digital, são medidas usadas para mapear áreas e lesões suspeitas, mesmo aquelas que nem podem ser vistas a olho nu.</p>
    <a href="#">
  ...
  <article class="container px-0 mt-3 mt-lg-5 mb-5">
    <div class="row mx-0 justify-content-center">
      <div class="col-lg-6 px-0">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/c-pele.svg" alt="Tratamento para Cancer de Pele - Aldo Dermatologia" class="img-fluid">
      </div>
      <div class="col-lg-6 pt-5 pl-lg-5">
        <h2>O que é câncer de pele?</h2>
        <p class="fs-14 mt-4">O câncer da pele responde por 33% de todos os diagnósticos desta doença no Brasil, sendo que o Instituto Nacional do Câncer (INCA) registra, a cada ano, cerca de 180 mil novos casos. A doença é provocada pelo crescimento anormal e descontrolado das células que compõem a pele. Essas células se dispõem formando camadas e, de acordo com as que forem afetadas, são definidos os diferentes tipos de câncer. Os mais comuns são os carcinomas basocelulares e os espinocelulares. Mais raro e letal que os carcinomas, o melanoma é o tipo mais agressivo de câncer da pele.</p>
      </div>
    </div>
  </article>

  <section class="container px-0 mt-3 mt-lg-5 mb-5">
    <h3 class="text-left text-lg-right mb-5 pl-3 pr-lg-3">Imagens Clínicas</h3>
    <div class="row mx-0">
      <div class="col-6 mb-4 col-lg-4">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/Rectangle 204.svg" alt="Imagem Aldo Dermato" class="img-fluid">
        <p class="text-center fs-14 mt-4">Lesão</p>
      </div>
  ...
  <section class="call__actions px-0 pt-1 pt-lg-5 container-fluid pb-4">
    <div class="row m-0 p-0 justify-content-between mt-5 mx-lg-5 text-center">
      <div class="col-lg-5 p-0">
        <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/close-eyes.svg" alt="Dermatologia Oncológica Aldo Dermato">
          <h4 class="my-5">Pele, Unhas e Cabelo</h4>
          <a href="/pele">
